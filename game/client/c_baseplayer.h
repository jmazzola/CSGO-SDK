...
public:// 0x1310
	...
	bool							m_bKilledByTaser; // 0x1C3A 
	int								m_iMoveState; // 0x1C3C 
	bool							m_bCanMoveDuringFreezePeriod; // 0x1C40 
	bool							m_isCurrentGunGameLeader; // 0x1C41 
	bool							m_isCurrentGunGameTeamLeader; // 0x1C42 
	char							m_szArmsModel[256]; // 0x1C43 
	int								m_iAddonBits; // 0x1D44 
	int								m_iPrimaryAddon; // 0x1D48 
	int								m_iSecondaryAddon; // 0x1D4C 
	int								m_iProgressBarDuration; // 0x1D50 
	float							m_flProgressBarStartTime; // 0x1D54 
	float							m_flStamina; // 0x1D58 
	int								m_iDirection; // 0x1D5C 
	int								m_iShotsFired; // 0x1D60 
	int								m_nNumFastDucks; // 0x1D64 
	bool							m_bDuckOverride; // 0x1D68 
	bool							m_bNightVisionOn; // 0x1D69 
	bool							m_bHasNightVision; // 0x1D6A 
	float							m_flVelocityModifier; // 0x1D6C 
	float							m_flGroundAccelLinearFracLastTime; // 0x1D70 
	int								m_iStartAccount; // 0x1D74 
	int								m_totalHitsOnServer; // 0x1D78 
	char							pad_0x1D7C[4]; //int
	int								m_hRagdoll; // 0x1D80 
	int								m_hCarriedHostage; // 0x1D84 
	int								m_hCarriedHostageProp; // 0x1D88 
	char							pad_0x1D8C[20]; // data missing
	bool							unkbool1; // 0x1DA0 
	bool							unkbool2; // 0x1DA1 
	bool							unkbool3; // 0x1DA2 
	float							m_flFlashMaxAlpha; // 0x1DA4 
	float							m_flFlashDuration; // 0x1DA8 
	float							m_flLastPrimaryAttack; // 0x1DAC 
	char							pad_0x1DB0[4];
	Vector							m_flOrigin2; // 0x1DB4 
	int								m_iGlowIndex; // 0x1DC0 
	char							pad_0x1DC4[24];
	C_BaseEntity*					someentitypointer; // 0x1DDC 
	char							pad_0x1DE0[12];
	char							m_iMatchStats_Kills[120]; // 0x1DEC 
	char							m_iMatchStats_Damage[120]; // 0x1E64 
	char							m_iMatchStats_EquipmentValue[120]; // 0x1EDC 
	char							m_iMatchStats_MoneySaved[120]; // 0x1F54 
	char							m_iMatchStats_KillReward[120]; // 0x1FCC 
	char							m_iMatchStats_LiveTime[120]; // 0x2044 
	char							m_iMatchStats_Deaths[120]; // 0x20BC 
	char							m_iMatchStats_Assists[120]; // 0x2134 
	char							m_iMatchStats_HeadShotKills[120]; // 0x21AC 
	char							m_iMatchStats_Objective[120]; // 0x2224 
	char							m_iMatchStats_CashEarned[120]; // 0x229C 
	char							pad_0x2314[96];
	short							m_unRoundStartEquipmentValue; // 0x2374 
	short							m_unFreezetimeEndEquipmentValue; // 0x2376 
	int								m_rank_1; // 0x2378 
	int								m_rank_2; // 0x237C 
	int								m_rank_3; // 0x2380 
	int								m_rank_4; // 0x2384 
	int								m_rank_5; // 0x2388 
	int								m_rank_6; // 0x238C 
	int								m_unMusicID; // 0x2390 
	int								m_iAccount; // 0x2394 
	bool							m_bHasHelmet; // 0x2398 
	int								m_iClass; // 0x239C 
	int								m_ArmorValue; // 0x23A0 
	Vector							m_angEyeAngles; // 0x23A4 
	bool							m_bHasDefuser; // 0x23B0 
	bool							m_bInHostageRescueZone; // 0x23B1 
	char							littlepad1[3]; // 0x23B2
	char							pad_0x23B4[12];
	bool							unkbool4; // 0x23C0 
	bool							unkbool5; // 0x23C1 
	bool							unkbool6; // 0x23C2 
	bool							m_bHud_MiniScoreHidden; // 0x23C3 
	bool							m_bHud_RadarHidden; // 0x23C4 
	int								m_nLastKillerIndex; // 0x23C8 
	char							pad_0x23CC[4];
	int								m_nDeathCamMusic; // 0x23D0 
	CInterpolatedVar<Vector>		m_iv_angEyeAngles; // 0x23D4 m_iv_angEyeAngles
	int								m_iCrossHairID; // 0x2400 
	char							pad_0x2404[212];
	char							m_bPlayerDominated[65]; // 0x24D8 
	char							m_bPlayerDominatingMe[65]; // 0x2519 
	char							littlepad2[2]; // 0x255A 
	char							m_iWeaponPurchasesThisRound[256]; // 0x255C
	// keeps going
};
...
inline void C_BasePlayer::dump()
{
	...
	SHOUTMEMBERPLAYER("m_CurrentFog.dirPrimary[0]", m_CurrentFog.dirPrimary[0]);
	...
	SHOUTMEMBERPLAYER("m_Local.m_skybox3d.fog.dirPrimary", m_Local.m_skybox3d.fog.dirPrimary[0]);
	...
	SHOUTMEMBERPLAYER("m_totalTime", m_totalTime);
	...
	SHOUTMEMBERPLAYER("pad_0x1D7C[4]", pad_0x1D7C);
	...
	SHOUTMEMBERPLAYER("pad_0x1D8C[20]",	pad_0x1D8C);
	SHOUTMEMBERPLAYER("unkbool1", unkbool1);
	SHOUTMEMBERPLAYER("unkbool2", unkbool2);
	SHOUTMEMBERPLAYER("unkbool3", unkbool3);
	...
	SHOUTMEMBERPLAYER("pad_0x1DB0[4]", pad_0x1DB0);
	SHOUTMEMBERPLAYER("m_flOrigin2", m_flOrigin2[0]);
	SHOUTMEMBERPLAYER("m_iGlowIndex", m_iGlowIndex);
	SHOUTMEMBERPLAYER("pad_0x1DC4[24]", pad_0x1DC4);
	SHOUTMEMBERPLAYER("someentitypointer", someentitypointer);
	SHOUTMEMBERPLAYER("pad_0x1DE0[12]",	pad_0x1DE0);
	...
	SHOUTMEMBERPLAYER("pad_0x2314[96]",	pad_0x2314);
	...
	SHOUTMEMBERPLAYER("littlepad1[3]", littlepad1);
	SHOUTMEMBERPLAYER("pad_0x23B4[12]",	pad_0x23B4);
	SHOUTMEMBERPLAYER("unkbool4", unkbool4);
	SHOUTMEMBERPLAYER("unkbool5", unkbool5);
	SHOUTMEMBERPLAYER("unkbool6", unkbool6);
	SHOUTMEMBERPLAYER("m_bHud_MiniScoreHidden", m_bHud_MiniScoreHidden);
	SHOUTMEMBERPLAYER("m_bHud_RadarHidden", m_bHud_RadarHidden);
	SHOUTMEMBERPLAYER("m_nLastKillerIndex", m_nLastKillerIndex);
	SHOUTMEMBERPLAYER("pad_0x23CC[4]", pad_0x23CC);
	SHOUTMEMBERPLAYER("m_nDeathCamMusic", m_nDeathCamMusic);
	SHOUTMEMBERPLAYER("m_iv_angEyeAngles", m_iv_angEyeAngles.m_pValue[0]);
	SHOUTMEMBERPLAYER("m_iCrossHairID", m_iCrossHairID);
	SHOUTMEMBERPLAYER("pad_0x2404[212]", pad_0x2404);
	SHOUTMEMBERPLAYER("m_bPlayerDominated[65]",	m_bPlayerDominated);
	SHOUTMEMBERPLAYER("m_bPlayerDominatingMe[65]", m_bPlayerDominatingMe);
	SHOUTMEMBERPLAYER("littlepad2[2]", littlepad2);
	SHOUTMEMBERPLAYER("m_iWeaponPurchasesThisRound[256]", m_iWeaponPurchasesThisRound);
	printf("\n");
}
